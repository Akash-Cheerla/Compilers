...
datatype Expr  = Const of int
     ...
     and BinOp = Plus
	       ...
	       | Div
         | Equal
datatype CmpExpr = Cmp_Expr of Expr *CMPOp * Expr 
    and  CMPOp = Equality
         | LessThan
         | GreaterThan
(*datatype Exps = Expr_list of [Expr list] list*)
...
datatype Part =
  Stmnts of Statement list
  | Ifprt of CmpExpr*(Part list)
...
(*fun binOpDenote Plus  x y = x + y
  ...
  | binOpDenote Equality x y = x ==y
  | binOpDenote LessThan x y = x<y
  | binOpDenote GreaterThan x y = x>y;
...
fun binOpToString Plus  = "+"
  ...
  | binOpToString Div   = "/"
  | binOpToString Equal = "="
fun cmpOpToString Equality = "=="
  | cmpOpToString LessThan = "<"
  | cmpOpToString GreaterThan = ">"
...
fun equality a b = Cmp_Expr (a,Equality, b)
fun lessthan a b = Cmp_Expr (a,LessThan, b)
fun greaterthan a b = Cmp_Expr (a,GreaterThan, b)
