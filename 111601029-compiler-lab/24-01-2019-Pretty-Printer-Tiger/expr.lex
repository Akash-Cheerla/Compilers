...
"("	      => ( Tokens.LPAR (!lineRef,!lineRef) );
")"	      => ( Tokens.RPAR (!lineRef,!lineRef) );
"/"		=> ( Tokens.DIV (!lineRef,!lineRef) );
";"       => (Tokens.SEMICOLON(!lineRef,!lineRef));
"{"       => ( Tokens.LCUR (!lineRef,!lineRef) );
"}"       => ( Tokens.RCUR (!lineRef,!lineRef) );
"if"      => ( Tokens.IF (!lineRef,!lineRef) );
"<"      => ( Tokens.LESSTHAN (!lineRef,!lineRef) );
"="	=> ( Tokens.EQUAL (!lineRef,!lineRef) );
"=="      => ( Tokens.EQUALITY (!lineRef,!lineRef) );
">"      => ( Tokens.GREATERTHAN (!lineRef,!lineRef) );
[a-zA-Z]+  => ( Tokens.ID (yytext,!lineRef,!lineRef) );
